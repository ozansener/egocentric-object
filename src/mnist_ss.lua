...
trainLogger = optim.Logger(paths.concat("logsss", 'trainss.log'))
testLogger = optim.Logger(paths.concat("logsss", 'testss.log'))
...
function train(dataset)
   ...
   local filename = paths.concat("logsss", 'mnistss.net')
