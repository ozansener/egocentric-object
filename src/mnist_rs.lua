...
testData = mnist.loadArtificialTestSet(nbTestingPatches, geometry)
...
trainLogger = optim.Logger(paths.concat("logsrs", 'trainrs.log'))
testLogger = optim.Logger(paths.concat("logsrs", 'testrs.log'))
...
function train(dataset)
   ...
   local filename = paths.concat("logsrs", 'mnistrs.net')
