...
mnist.path_artificial_testset = paths.concat(mnist.path_artificial_dataset, 'artificial_mnist_test.t7')
...
function mnist.loadArtificialTrainSet(maxLoad, geometry)
   return mnist.loadDataset(mnist.path_artificial_trainset, maxLoad, geometry)
end

function mnist.loadArtificialTestSet(maxLoad, geometry)
   return mnist.loadDataset(mnist.path_artificial_testset, maxLoad, geometry)
end
